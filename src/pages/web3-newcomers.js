...
import IMG1 from 'assets/defi.svg';
import IMG2 from 'assets/defi1.svg';
const data = {
  subTitle: 'WEB3 NEWCOMERS',
  title: 'As quick as shopping<br/> online',
  description:
...
export default function Web3NewcomersPage() {
  return (
